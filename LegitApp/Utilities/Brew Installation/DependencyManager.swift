...
struct DependencyManager {
    ...
    /// Installs dependencies to `~/Library/Application Support/LegitApp/homebrew/`
    ///
    /// - Parameters:
    ...
    static func installHomebrew() async throws -> Void {
        ...
        // Delete Homebrew directory (~/Library/Application Support/LegitApp/homebrew) if exists so we have a clean install
        ...
        // Set selected Homebrew path to LegitApp's installation
