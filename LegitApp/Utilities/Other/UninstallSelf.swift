...
/// This function will uninstall LegitApp and all it's related files
func uninstallSelf(deleteBrewCache: Bool, uninstallHomebrew: Bool = false) async throws {
    let logger = Logger()
    
    logger.notice("LegitApp uninstallation stated. deleteBrewCache: \(deleteBrewCache), uninstallHomebrew: \(uninstallHomebrew)")
